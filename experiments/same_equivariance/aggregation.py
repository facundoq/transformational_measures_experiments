...
class AggregationBeforeAfter(SameEquivarianceExperiment):
...
class AggregationFunctionsVariance(SameEquivarianceExperiment):
    def description(self):
...
class AggregationFunctionsDistance(SameEquivarianceExperiment):
    def description(self):
