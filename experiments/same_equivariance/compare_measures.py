...
class MeasureCorrelationWithTransformation(SameEquivarianceExperiment):
...
class InvarianceMeasureCorrelation(SameEquivarianceExperiment):
    def description(self):
...
class CompareMeasures(SameEquivarianceExperiment):
    def description(self):
...
class CompareGoodfellowAlpha(SameEquivarianceExperiment):
...
class CompareGoodfellow(SameEquivarianceExperiment):
...
class CompareSameEquivarianceSimple(SameEquivarianceExperiment):
    ...
    def run(self):
        ...
        for model_config_generator, dataset, transformation in combinations:
            ...
            tmv.plot_collapsing_layers_same_model(results, plot_filepath, labels=labels)
class CompareSameEquivariance(SameEquivarianceExperiment):
...
class DistanceApproximation(SameEquivarianceExperiment):
    def description(self):
