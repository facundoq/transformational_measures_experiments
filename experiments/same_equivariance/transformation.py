...
class TransformationSetSize(SameEquivarianceExperiment):
...
class TransformationComplexity(SameEquivarianceExperiment):
...
class TransformationDiversity(SameEquivarianceExperiment):
