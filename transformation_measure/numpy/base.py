...
class MeasureResult:
    ...
    def collapse_convolutions(self,conv_aggregation_function:ConvAggregation)->'MeasureResult':
...
class Measure():
    ...
    def eval_stratified(self,classes_iterators:[ActivationsIterator],class_labels:[str])-> StratifiedMeasureResult:
        ...
        # think of a "filter layers" function that selects on which layers to calculate the numpy
