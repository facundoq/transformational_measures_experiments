...
./experiment_training.py -m "AllConvolutional" -d "cifar10" -transformation "Affine(r=0,s=0,t=0)"
...
./experiment_training.py -m "AllConvolutional" -d "cifar10" -transformation "Affine(r=0,s=16,t=0)"